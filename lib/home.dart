...
import 'package:WebDemo/utils/responsive_layout.dart';
import 'package:WebDemo/widget/button_row.dart';
import 'package:WebDemo/utils/flutter_swiper.dart';
...
//                      child: ClipRRect(
//                        borderRadius: BorderRadius.circular(20),
//                        child: Hero(tag: i, child: icons[i]),
//                      ));
//                },
//                viewportFraction: .70,
//                scale: .9)),
            ...
            child: IntrinsicHeight(
              child: Column(
                children: <Widget>[
                  Expanded(
                    flex: 2,
                    child: Image.asset("header_background.png",
                        fit: BoxFit.contain),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "Flutter Hack Series By Jadav Chirag",
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.w600,
                                fontSize: 16.0,
                          ...
                          Text(
                            "The Bitter Truth About Flutter Hack Series",
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.w600,
                                fontSize: 35.0,
